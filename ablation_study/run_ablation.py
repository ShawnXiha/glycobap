...
TEST_DATA = [
    ...
    {"id": "G2", "iupac": "Gal(b1-4)GlcNAc(b1-2)Man(a1-6)[Gal(b1-4)GlcNAc(b1-2)Man(a1-3)]Man(b1-4)GlcNAc(b1-4)GlcNAc", "residues": 9, "linkages": 8, "category": "n_glycan"},
    ...
    # Sialylated
    {"id": "LNnT-Sia", "iupac": "Neu5Ac(a2-3)Gal(b1-4)GlcNAc(b1-3)Gal(b1-4)Glc", "residues": 5, "linkages": 4, "category": "sialylated"},
    {"id": "LSTb", "iupac": "Neu5Ac(a2-6)Gal(b1-4)GlcNAc(b1-3)Gal(b1-4)G