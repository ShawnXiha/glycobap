...
%==============================================================================
% ABSTRACT - UPDATED with extended PDB validation (n=12)
%==============================================================================
\begin{abstract}
...
\noindent\textbf{Validation:} The pipeline was validated through multiple approaches: (1) benchmark evaluation on 50 diverse glycan structures achieving 98.5\% epimer accuracy (95\% CI: [96.2\%, 99.8\%]), 98.2\% anomeric accuracy (95\% CI: [95.8\%, 99.6\%]), and 96.8\% linkage accuracy (95\% CI: [93.5\%, 99.2\%]); (2) extended PDB structure comparison against 12 known correct structures demonstrating 75\% overall CCD mapping accuracy with 100\% accuracy on the 4 critical stereochemistry test cases; and (3) literature error correction on 10 documented cases showing 100\% correction rate. Processing time is $<$1 second per structure versus 30--60 minutes for manual specification.

\noindent\textbf{Conclusions:} GlycoSMILES2BAP addresses a key input format barrier for AF3 glycan modeling, enabling accurate, reproducible structure prediction for the glycobiology community. The extended PDB validation confirms correct handling of critical stereochemistry cases including sialic acid C2 anomeric position and fucose L-configuration, while identifying parser limitations for complex multi-residue glycans.
...
%==============================================================================
% INTRODUCTION - UPDATED with tool comparison
%==============================================================================
\section{Introduction}

Glycans are essential biological molecules involved in protein folding, cell signaling, immune recognition, and pathogen interaction \citep{varki