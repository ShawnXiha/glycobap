...
\author{Qiang Xia\thanks{Corresponding author: xiaqiang@xinghetea.com} \\
\textit{Zhejiang Xinghe Tea Technology Co., Ltd.} \\
\textit{Hangzhou, Zhejiang, China}}
...
Glycosylation is one of the most prevalent post-translational modifications in eukaryotic proteins, affecting over 50\% of the human proteome \citep{varki2017}. Glycans play essential roles in protein folding, cell-cell recognition, immune responses, and pathogen-host interactions \citep{helenius2004}. The structural diversity of glycans---arising from variations in monosaccharide composition, linkage positions, anomeric configurations ($\alpha$/$\beta$), and branching patterns---poses significant challenges for structural characterization.